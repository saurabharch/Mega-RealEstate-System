...
<br>
    ...
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item"><a href="<?= base_url();?>/backend/user/developers/">Developers</a></li>  
    </ol> 
    </nav>
    <br>  
    ...
    <div class="col-md-9">
       ...
       <?php if($section =="profile"){ ?>
        <?php //print_r($profile);?> 
        <h3 class="display-4" style="margin-left:100px">Realestate Developer Profile</h3>
       ...
       <?php }elseif($section =="edit"){ ?>
        ...
        <div class="container">  
                <h3 class="display-4">Edit Developers/Builders</h3>
                <div class="row">
                 <div class="col-md-3">
                  ...
                  <?php } ?>
                   ...
                   <div class="col-md-6" style="margin-top: 30px;">
                        <?= form_open('backend/user/developers/edit/'.segment(5),'accept-charset="utf-8" enctype="multipart/form-data"') ?>
             ...
             <?= form_open('backend/user/developers/edit/'.segment(5)) ?>
       ...
       <?php }else{ ?>
        ...
        <h3 class="display-4">
        Developers & Builders
         <select class="btn btn-light btn-sm" name="role" id="role" onchange="window.location.href='<?= base_url();?>/backend/user/developers/?role='+this.value">
            <option value="developer" <?= ($cRole == 'developer') ? "selected" : "";?> >Developer</option> 
            <option value="builder" <?= ($cRole == 'builder') ? "selected" : "";?> >Builder</option>  
        </select> 
       </h3>
        <div class="table-responsive">
          <table class="table small">
              <caption>List of Realestate Developers & Builders</caption> 
              <thead>
                <tr>
                  <th scope="col">#</th> 
              ...
              <tbody>
               <?php if(is_array($rs_developers)) : ?>
                <?php $i = 1;foreach($rs_developers as$rsd) : ?>  
                <tr style="line-height: 57px">
                  <th scope="row"><?= $i;?></th>
                  <td>
                    <?php if($rsd['profile_pic']){ ?>
                       <img src="<?= publicFolder().'/user-images/thumbnails/'.$rsd['profile_pic'];?>" class="shadow-lg mx-auto d-block rounded" width="100"/>
                    <?php }else{ ?>
                       <img src="<?= publicFolder().'/images/customer-2.png';?>" class="shadow-lg mx-auto d-block rounded" width="100"/>
                    <?php } ?>
                    
                  </td>
                  <td><?= $rsd['firstname'] ? $rsd['firstname'].' '.$rsd['lastname'] : 'No Name';?></td>
                  <td><?= $rsd['email'];?></td>
                  <td><?= $rsd['mobile'];?></td>
                  <td><?= strtoupper(str_replace('_',' | ', $rsd['activity']));?></td>
                  <td><?= date('D, d M Y', strtotime($rsd['created_at']));?></td>
                  <td><?= date('D, d M Y', strtotime($rsd['updated_at']));?></td>
                  <td><label class="<?= $rsd['status_badge'];?>"><?= $rsd['status_name'];?></label></td>
                  <td>
                     <a href="<?= base_url();?>/backend/user/developers/profile/<?= $rsd['user_id'];?>">
                      <img src="<?= publicFolder();?>/images/view.png"  width="20"/>
                     </a>  |
                     <a href="<?= base_url();?>/backend/user/developers/edit/<?= $rsd['user_id'];?>">
                      <img src="<?= publicFolder();?>/images/edit.png"  width="20"/> 
                    </a>  |   
                    <a href="javascript:void(0)" data-confirmedUrl="<?= base_url();?>/backend/user/developers/delete/<?= $rsd['user_id'];?>" class="deletePop" />  
